...
def parse_args():
    ...
    parser.add_argument('--n_generator', type=int, default=2, help='')
    ...
    parser.add_argument('--manual_seed', type=int, default=123) # Added by Igor Buzhinsky: -1 == do not set seed (randomized run)
    ...
    # Added by Igor: clipping of KL divergence differences
    parser.add_argument('--kl_margin', type=float, default=0.0, help='Maximum allowed difference of KL divergences (0=disabled)')
